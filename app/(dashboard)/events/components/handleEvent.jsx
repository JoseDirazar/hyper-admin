...
export default function HandleEvent({ eventStatus, eventId, handleStatus }) {
  ...
  {eventStatus && (  <button
      key={824778234874}
      className="bg-red-500 text-white rounded-full px-4 py-3 m-4 border border-red-600 hover:bg-red-600 focus:outline-none focus:ring focus:ring-red-300"
  ...
  { !eventStatus && (<button
      key={78234762}
      className="bg-blue-500 text-white rounded-full  px-4 py-3 m-4 border border-blue-600 hover:bg-blue-600 focus:outline-none focus:ring focus:ring-blue-300"
